...
function connect() {
  window.aptos.account().then((address) => {
    addr = address;
    document.getElementById("addr").innerHTML = "Address: " + addr;
  });
...
function updateParameters() {
  console.log("Loaded");
  document.getElementById("review-nft-title").innerHTML =
    document.getElementById("nft-name").value;
  document.getElementById("review-nft-description").innerHTML =
    document.getElementById("nft-description").value;

  let licenseType = document.getElementById("license-type");
  document.getElementById("review-nft-license").innerHTML =
    licenseType.options[licenseType.selectedIndex].value;
}
